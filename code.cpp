...
int main() {
    ...
    if (lwcount > 0){
    lw_average = 100*(labwork/lwcount);
    }
    if(zycount){
    reading = zybook/zycount;
    }
    reading = reading + 15;
    if (reading > 100){
        reading = 100;
    ...
    //compileCheck_average = compcheck / 2;
    // lw_average = compileCheck_average*lw_average;
    if (compcheck == 0){
        lw_average = 0;
    }else if (compcheck == 1){
        lw_average *= 0.5;
    }else{
        lw_average = lw_average;
    }
